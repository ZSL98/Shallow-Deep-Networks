...
class custom_resnet_p1(nn.Module):
    def __init__(
        self,
        ...
        super(custom_resnet_p1, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
...
class custom_resnet_p2(nn.Module):
    def __init__(
        self,
        ...
        super(custom_resnet_p2, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        self._norm_layer = norm_layer
